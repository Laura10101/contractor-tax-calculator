...
- [Testing](#testing)
   ...
   * [Browser Compatability](#browser-compatability)
      ...
      + [The Contractor Dashboard](#the-contractor-dashboard)
      + [The Subscription Options Page](#the-subscription-options-page)
      + [The Checkout Form](#the-checkout-form)
      + [The Payment Status Page](#the-payment-status-page)
      + [The Select Jurisdictions Form](#the-select-jurisdictions-form)
      + [The Financial Information Form](#the-financial-information-form)
      + [The Tax Calculation Results Page](#the-tax-calculation-results-page)
      + [The Config App - Creating Questions](#the-config-app---creating-questions)
      + [The Config App - Creating Rulesets](#the-config-app---creating-rulesets)
      + [The Config App - Creating Rules](#the-config-app---creating-rules)
      + [The Config App - Editing Rules](#the-config-app---editing-rules)
      + [The Config App - Creating Rule Tiers](#the-config-app---creating-rule-tiers)
   ...
   * [Responsiveness](#responsiveness)
      + [The Index Page](#the-index-page-1)
      + [The Contractor Dashboard](#the-contractor-dashboard-1)
      + [The Subscription Options Page](#the-subscription-options-page-1)
      + [The Checkout Form](#the-checkout-form-1)
      + [The Payment Status Page](#the-payment-status-page-1)
      + [The Select Jurisdictions Form](#the-select-jurisdictions-form-1)
      + [The Financial Information Form](#the-financial-information-form-1)
      + [The Tax Calculation Results Page](#the-tax-calculation-results-page-1)
      + [The Config App - Questions Display](#the-config-app---questions-display)
      + [The Config App - Creating Questions](#the-config-app---creating-questions-1)
      + [The Config App - Rulesets Display](#the-config-app---rulesets-display)
      + [The Config App - Creating Rulesets](#the-config-app---creating-rulesets-1)
      + [The Config App - Creating Rules](#the-config-app---creating-rules-1)
   * [JavaScript Tests](#javascript-tests)
      + [Running the Jest tests](#running-the-jest-tests)
