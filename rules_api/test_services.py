...
def test_delete_rule():
    rule_id = create_mock_flat_rate_Rule(
        'salary',
        20,
        create_mock_ruleset()
    ).id
...
def test_create_secondary_tiered_rate_rule_with_null_data():
    ...
    with pytest.raises(RuleSet.DoesNotExist):
        id = create_secondary_tiered_rate_rule(
            ruleset_id,
            primary_rule_id,
            name,
            ordinal,
...
def test_create_secondary_tiered_rate_rule_with_null_ruleset_id():
    ruleset = create_mock_ruleset()
    ruleset_id = None
    primary_rule_id = create_mock_tiered_rate_rule(
        'Test Tiered Rule', 1, ruleset
    ).id
    name = 'Test Rule'
    ordinal = 1
    explainer = 'Test explainer'
...
@pytest.mark.django_db
def test_create_secondary_rule_tier_with_null_ordinal():
    primary_rule = create_mock_tiered_rate_rule(
        'salary',
        1,
        create_mock_ruleset()
...
@pytest.mark.django_db
def test_create_secondary_rule_tier_with_non_numeric_ordinal():
    primary_rule = create_mock_tiered_rate_rule(
        'salary',
        1,
        create_mock_ruleset()
...
@pytest.mark.django_db
def test_update_secondary_rule_tier_with_null_ordinal():
    primary_rule = create_mock_tiered_rate_rule(
        'salary',
        1,
        create_mock_ruleset()
    ...
    with pytest.raises(ValidationError):
        update_secondary_rule_tier(id, ordinal, tier_rate)


@pytest.mark.django_db
def test_update_secondary_rule_tier_with_non_numeric_ordinal():
    primary_rule = create_mock_tiered_rate_rule(
        'salary',
        1,
        create_mock_ruleset()
